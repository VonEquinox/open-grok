...
pub enum NotificationProtocol {
    ...
    Osc9,
    /// Kitty: `\x1b]99;i=open-grok;{message}\x1b\\`
    Osc99,
...
fn notification_sequence(
    ...
    Some(match protocol {
        ...
        // OSC 777 already uses the tab title as subtitle, so use the app name.
